...
function focusPlusContext(data) {
    ...
    var navYScale = d3.scaleTime().range([height2, 0]);
    ...
    */
    ...
    small_points = dots.selectAll("dot")
        //here...
        .data(data.features).enter().append("circle").attr("class", "dotContext")
    ...
    */
    ...
    selected_dots = dots.selectAll("dot")
        ...
        //.enter(data.features).append("circle").attr("class", "dot")
        .data(data.features).enter().append("circle").attr("class", "dot")
        .style("opacity", 0.5)
